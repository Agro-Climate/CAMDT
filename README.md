...
3) Weather fiels (*.WTD and *.WTH) are GENERATED data, based on actual monthly statistics. Users can use their own observed data to use the tool in their location
